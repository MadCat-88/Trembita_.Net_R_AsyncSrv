...
| Метод HTTP |  Код сервісу  | Базова URL                      |
|:----------:|:-------------:|---------------------------------|
|    GET     |  Person Post  | http://your-server-ip:5118/api  |
|    GET     |  Person Post  | https://your-server-ip:7284/api |
...
| Метод HTTP |  Код сервісу  | Базова URL                      |
|:----------:|:-------------:|---------------------------------|
|    PUT     |  Person Post  | http://your-server-ip:5118/api  |
|    PUT     |  Person Post  | https://your-server-ip:7284/api |
